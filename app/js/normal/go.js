...
function go () {
  typish('#typer')
    ...
    .type('今天司先生教你写代码呀', '<span class="note">')
    .type('0', '<br>')
    .type('00', '<span class="blank">')
    .wait(10)
...
function stars () {
  ...
  comment.innerHTML = '亲爱的，七夕节快乐！！'
  document.body.appendChild(comment)

  let comment2 = document.createElement('div')
  comment2.className = 'comment2'
  comment2.style.bottom = 120 + comentsLength * 55 + 'px'
  comment2.innerHTML = '请继续等待三秒，有彩蛋~~~'
